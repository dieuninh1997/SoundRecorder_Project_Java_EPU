...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(RecordItem item) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        minutes = java.util.concurrent.TimeUnit.MILLISECONDS.toMinutes(itemDuration);
        seconds = java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(itemDuration)
        ...
        mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(mMediaPlayer != null && fromUser) {
                    ...
                    long seconds = java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(mMediaPlayer.getCurrentPosition())
                            - java.util.concurrent.TimeUnit.MINUTES.toSeconds(minutes);
    ...
    private void startPlaying() {
        mPlayButton.setImageResource(R.drawable.ic_pause_white_24px);
    ...
    private void pausePlaying() {
        mPlayButton.setImageResource(R.drawable.ic_play_arrow_white_24px);
        mHandler.removeCallbacks(mRunnable);
        mMediaPlayer.pause();
    }
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            if(mMediaPlayer != null){
                ...
                long seconds = java.util.concurrent.TimeUnit.MILLISECONDS.toSeconds(mCurrentPosition)
                        - java.util.concurrent.TimeUnit.MINUTES.toSeconds(minutes);
                mCurrentProgressTextView.setText(String.format("%02d:%02d", minutes, seconds));
...
//    public void show(FragmentTransaction transaction, String a) {
//
//    }
}
